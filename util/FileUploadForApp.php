...
class FileUploadForApp
{
    ...
    public function __construct($fileName = "file", $maxSize = 10485760, $savaFile = "../images/head_icon", $allowTypes = array("jpg", "png", "bmp", "jpeg", "gif"), $isImage = true)
    {
